...
function start() {
    ...
    */
    ...
    const spritesSheet = /** @type {HTMLCanvasElement} */ (document.getElementById('spritesheet'));
    ...
    function drawShip(x, y) {
        ctx.drawImage(spritesSheet, shipSprite.x, shipSprite.y, shipSprite.w, shipSprite.h, x - shipSprite.w / 2, y - shipSprite.h, shipSprite.w, shipSprite.h);
    }
    ...
    function drawAlien(x, y) {
        ctx.drawImage(spritesSheet, alienSprite.x, alienSprite.y, alienSprite.sw, alienSprite.sh, x - alienSprite.w / 2, y - alienSprite.h, alienSprite.w, alienSprite.h);
    }
